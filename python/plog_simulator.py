...
Conventions:
    ...
    - f_tag_* formulas: Fallacy detection rules (toggleable)
"""
...
FALLACY_TAG_FORMULA_PREFIX = "f_tag_"
...
def main():
    if len(sys.argv) < 2:
        ...
        print("═" * 60)
        print("\nAnalyze text for logical fallacies and contradictions.")
        print("\nUsage:")
        print("  python plog_simulator.py <plog_file>                  # Run analysis")
        print("  python plog_simulator.py --interactive <plog_file>    # Interactive mode")
        print("\nConventions:")
        print("  ATOM FALLACY_*     - Fallacy type markers (hidden metadata)")
        print("  FORMULA f_tag_*    - Fallacy detection rules (toggleable)")
        print("\n" + "═" * 60 + "\n")
        sys.exit(1)
